...
4、注意事项
    ...
    3.开发板默认PA9,PA10跳帽接到NSLINK的虚拟串口，若工程中PA9，PA10不作串口，用作其他用途，须拔掉串口跳帽。
...
4. Matters needing attention
	...
	3.When using the development board, PA9 and PA10 are connected by default to the virtual serial port on NSLINK. If in your project, 
	  PA9 and PA10 are not used as serial ports but for other purposes, you must remove the serial port jumpers