...
3. Instructions for use
    ...
    Instructions:
        ...
        2. By changing the voltage of the PA4 PA5 pin, the rule and injection channel are converted once every CC2 event occurs, and the variables are stored in the corresponding array. 
		   At the same time, you can see the PWM waveform of TIM1 CH2 on PA9
