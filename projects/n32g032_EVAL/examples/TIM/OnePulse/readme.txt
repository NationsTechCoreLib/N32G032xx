...
3. Instructions for use
     System Configuration;
         ...
         2. Port configuration:
                     ...
                     PA7 is selected as the CH2 input of TIM4
                     PA3 is selected as IO output
         3. TIM:
                     TIM4 configures CH2 rising edge to trigger CH1 to output a single pulse
     Instructions:
         1. Open the debug mode after compiling, connect PA3 to PA7, and observe the waveform of CH1 of TIM4 with an oscilloscope or logic analyzer
         2. Add the variable gSendTrigEn to the watch window, the default gSendTrigEn=0, every time you manually modify gSendTrigEn=1, you will see a single pulse output on the TIM4 CH1 port
