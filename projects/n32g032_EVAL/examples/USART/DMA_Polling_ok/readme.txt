...
USARTz. USARTz receives DMA data to RxBuffer2, compare the two groups of receiving and sending data respectively, and store the comparison results in the TransferStatus2 variable.
    At the same time, DMA transfers TxBuffer2 data to the USARTz send data register, and then the data is 
sent to USARTy. USARTy receives DMA data to RxBuffer1, compare the two groups of receiving and sending data respectively, and store the comparison results in the TransferStatus1 variable.
...
3. Instructions for use
    ...
    -DMA transmission mode is enabled, DMA reception mode is enabled
