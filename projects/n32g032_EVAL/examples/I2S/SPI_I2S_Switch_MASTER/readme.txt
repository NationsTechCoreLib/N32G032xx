...
1. Functional Description:
    1. After completing data transmission in I2S master mode, switch to SPI master mode for data transmission, and then switch back to I2S slave mode for data transmission.
